...
export function ReportsPage() {
  ...
  return (
    <>
      ...
      <div className="page-note"><span className="page-note__line" /><p>Files are stored as reports. OCR, medical interpretation and AI explanations will be added in a later phase.</p></div>
    </>
  )
}
